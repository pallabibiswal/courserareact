...
class Contact extends Component {
    ...
    validate = (firstname, lastname, telnum, email) => {
        ...
        if (this.state.touched.firstname && firstname.length < 3) {
            errors.firstname = 'First Name length must be >= 3';
        } else if (this.state.touched.firstname && firstname.length > 10) {
            errors.firstname = 'First Name length must be <= 10';
        }

        if (this.state.touched.lastname && lastname.length < 3) {
            errors.lastname = 'Last Name length must be >= 3';
        } else if (this.state.touched.lastname && lastname.length > 10) {
            errors.lastname = 'Last Name length must be <= 10';
        }
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{size:3, offset:1}}>
                                    <Input type="select" id="contactType" name="contactType"
                                           value={this.state.contactType} onChange={this.handleInputChanges}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Input>
                                </Col>
                            ...
                            <FormGroup row>
                                ...
                                <Col md="10">
                                    <Input type="textarea" id="message" name="message" rows="12"
                                           value={this.state.message} onChange={this.handleInputChanges}/>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
